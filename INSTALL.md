...
```bash
# 使用 environment.yml 创建环境（包含 Python 3.10、PyTorch 2.10.0 CUDA 12.6 及所有依赖）
...
```bash
pip install torch==2.10.0 torchaudio==2.10.0 --extra-index-url https://download.pytorch.org/whl/cu126
```
